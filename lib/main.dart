...
import 'package:moneymate_project/screens/add_transaction_screen.dart';
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Ringkasan', style: theme.textTheme.titleLarge?.copyWith()),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text('Transaksi Terbaru', style: theme.textTheme.titleLarge),
            ),
            const SizedBox(height: 8),
            TabBar(
